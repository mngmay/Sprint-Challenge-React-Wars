...
React JS is a UI Component Library made by Facebook that specializes in rendering UI really well. It addresses handling the various state of data and makes it easier to scale dynamic, interactive webpages.
...
Properties passed down as an object from parent to child components.
